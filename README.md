...
- [**Ansible**](./Ansible)
  ...
  - [**playbooks**](./Ansible/playbooks)
    ...
    - [user-dir.yml](./Ansible/playbooks/user-dir.yml)
...
- [**Docker**](./Docker)
  ...
  - [**Both**](./Docker/Both)
    ...
    - [**binfmt**](./Docker/Both/binfmt)
      - [Dockerfile](./Docker/Both/binfmt/Dockerfile)
      - [docker-compose.yml](./Docker/Both/binfmt/docker-compose.yml)
      - [run-bifmt.sh](./Docker/Both/binfmt/run-bifmt.sh)
    ...
    - [**coder**](./Docker/Both/coder)
      - [docker-compose.yml](./Docker/Both/coder/docker-compose.yml)
    ...
    - [**db-backup**](./Docker/Both/db-backup)
      - [.env.example](./Docker/Both/db-backup/.env.example)
      - [docker-compose.yml](./Docker/Both/db-backup/docker-compose.yml)
    ...
    - [**passwdpusher**](./Docker/Both/passwdpusher)
      - [.env.example](./Docker/Both/passwdpusher/.env.example)
      - [docker-compose.yml](./Docker/Both/passwdpusher/docker-compose.yml)
    - [**photoprism**](./Docker/Both/photoprism)
      - [**photoprism-1**](./Docker/Both/photoprism/photoprism-1)
        - [.env.example](./Docker/Both/photoprism/photoprism-1/.env.example)
        - [docker-compose.yml](./Docker/Both/photoprism/photoprism-1/docker-compose.yml)
      - [**photoprism-2**](./Docker/Both/photoprism/photoprism-2)
        - [.env.example](./Docker/Both/photoprism/photoprism-2/.env.example)
        - [docker-compose.yml](./Docker/Both/photoprism/photoprism-2/docker-compose.yml)
      - [**photoprism-3**](./Docker/Both/photoprism/photoprism-3)
        - [.env.example](./Docker/Both/photoprism/photoprism-3/.env.example)
        - [docker-compose.yml](./Docker/Both/photoprism/photoprism-3/docker-compose.yml)
    ...
    - [**tdarr**](./Docker/Both/tdarr)
      ...
      - [Tdarr_Node_Config.json](./Docker/Both/tdarr/Tdarr_Node_Config.json)
...
- [**Docs**](./Docs)
  ...
  - [**Linux**](./Docs/Linux)
    - [H-W-T-StartupScript.md](./Docs/Linux/H-W-T-StartupScript.md)
    - [**Shells**](./Docs/Linux/Shells)
      - [Powerlevel10k.md](./Docs/Linux/Shells/Powerlevel10k.md)
      - [ShellInfo.md](./Docs/Linux/Shells/ShellInfo.md)
    - [adduser.md](./Docs/Linux/adduser.md)
    - [permissions.md](./Docs/Linux/permissions.md)
  ...
  - [**Functions**](./PCSMenu/Functions)
    - [**Ansible**](./PCSMenu/Functions/Ansible)
      - [**Setup Linux Machine**](./PCSMenu/Functions/Ansible/Setup Linux Machine)
        - [setupLinuxMachine.sh](./PCSMenu/Functions/Ansible/Setup Linux Machine/setupLinuxMachine.sh)
      - [**Update Hosts**](./PCSMenu/Functions/Ansible/Update Hosts)
        - [updateHosts.sh](./PCSMenu/Functions/Ansible/Update Hosts/updateHosts.sh)
    - [**Docker**](./PCSMenu/Functions/Docker)
      - [**Docker Install**](./PCSMenu/Functions/Docker/Docker Install)
        - [dockerInstall.sh](./PCSMenu/Functions/Docker/Docker Install/dockerInstall.sh)
      - [**Docker Update**](./PCSMenu/Functions/Docker/Docker Update)
        - [dockerUpdate.sh](./PCSMenu/Functions/Docker/Docker Update/dockerUpdate.sh)
      - [**Provision Docker Service**](./PCSMenu/Functions/Docker/Provision Docker Service)
        - [provisionDockerService.sh](./PCSMenu/Functions/Docker/Provision Docker Service/provisionDockerService.sh)
    ...
    - [**Proxmox**](./PCSMenu/Functions/Proxmox)
      - [**Provision LXC with Docker Service**](./PCSMenu/Functions/Proxmox/Provision LXC with Docker Service)
        - [provisionLxcDockerService.sh](./PCSMenu/Functions/Proxmox/Provision LXC with Docker Service/provisionLxcDockerService.sh)
    ...
    - [**Tools**](./PCSMenu/Functions/Tools)
      - [**Run Script-Return Output**](./PCSMenu/Functions/Tools/Run Script-Return Output)
        - [executeCommand.sh](./PCSMenu/Functions/Tools/Run Script-Return Output/executeCommand.sh)
